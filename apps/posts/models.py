...
class Post(models.Model):
    ...
    slug = models.SlugField(max_length=250, unique=True, db_index=True, allow_unicode=False)
    search_vector = models.GeneratedField(
        expression=SearchVector("title", config="english") + SearchVector("content", config="english"),
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=['status', 'deleted_at', 'created_at'], name="status_deleted_created_idx")
        ]